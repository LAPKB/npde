...
#' Select plot for a NpdeObject object
#'
#' @usage npde.plot.select(npdeObject,data=FALSE,ecdf=FALSE,qqplot=FALSE,
#'   histogram=FALSE,x.scatter=FALSE,pred.scatter=FALSE,x.box=FALSE,pred.box=FALSE,
#'   cov.x.scatter=FALSE,cov.pred.scatter=FALSE,cov.x.box=FALSE,cov.pred.box=FALSE,
#'   cov.ecdf=FALSE, vpc=FALSE,...)
...
#' @param ecdf boolean, whether to produce a distribution plot of the empirical
#'   distribution function
#' @param qqplot boolean, whether to produce a QQ-plot of the empirical
#'   distribution function
#' @param histogram boolean, whether to produce a histogram of the metric
#' @param x.scatter boolean, whether to produce a scatterplot of the metric as a
#'   function of X
#' @param pred.scatter boolean, whether to produce a scatterplot of the metric
#'   as a function of predictions
#' @param x.box boolean, whether to produce whisker plots of the metric as a
#'   function of X
#' @param pred.box boolean, whether to produce whisker plots of the metric as a
#'   function of predictions
#' @param cov.x.scatter boolean, whether to produce a scatterplot of the metric
#'   as a function of X, split by covariate(s)
#' @param cov.pred.scatter boolean, whether to produce a scatterplot of the
#'   metric as a function of predictions, split by covariate(s)
#' @param cov.x.box boolean, whether to produce whisker plots of the metric as a
#'   function of X, split by covariate(s)
#' @param cov.pred.box boolean, whether to produce whisker plots of the metric
#'   as a function of predictions, split by covariate(s)
#' @param cov.ecdf boolean, whether to produce a distribution plot of the
#'   empirical distribution function, split by covariate(s)
#' @param vpc boolean, whether to produce a VPC
#' @param \dots additional arguments to be passed on to the function, to control
#'   which metric (npde, pd, npd) is used or to override graphical parameters
#'   (see the PDF document for details, as well as
#'   \code{\link{setPlotOptions}})
...
#' @param npdeObject an object returned by a call to \code{\link{npde}} or
#'   \code{\link{autonpde}}
#' @param which one of "x" (scatterplots of the metric versus X), "pred"
#'   (scatterplots of the metric versus predictions) or "ecdf" (empirical
#'   distribution function)
#' @param \dots additional arguments to be passed on to the function, to control
#'   which metric (npde, pd, npd) is used or to override graphical parameters
#'   (see the PDF document for details, as well as
...
#'
#' @aliases npde.plot.data npde.plot.dist npde.plot.scatter npde.plot.vpc
#'   npde.plot.loq aux.scatter.box aux.scatter compute.bands.true compute.bands
#' @param npdeObject an object returned by a call to \code{\link{npde}} or
#'   \code{\link{autonpde}}
#' @param \dots additional arguments to be passed on to the function, to control
#'   which metric (npde, pd, npd) is used or to override graphical parameters
